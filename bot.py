...
CATEGORIES = {
    ...
    "Здоровье": ["apotheke", "pharmacy", "arzt", "doctor", "медицин", "аптека", "psycholog", "линзы", "brillen", "здоровье", "dm ", "rossmann", "petrishcheva", "петришева", "marina"],
    ...
    "Немецкий": ["schule", "kurs", "deutsch", "немецкий", "volkshochschule", "vhs", "ahso", "ксенія", "ксения", "xenia"],
